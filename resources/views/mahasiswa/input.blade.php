        ...
        <form action="{{ route('mahasiswa.simpan') }}" method="POST">
            ...
            <tr>
                    ...
                    <tr>
                        ...
                        <td class="p-4"><input type="text" id="NRP" name="NRP" required class="w-full p-2 border rounded border-black"></td>
                    </tr>
                    <tr>
                        <td class="p-4"><label for="GPA">GPA:</label></td>
                        <td class="p-4"><input type="number" id="GPA" name="GPA" step="0.01" min="0" max="4" required class="w-full p-2 border rounded border-black"></td>
                    </tr>
                    <tr>
                        <td class="p-4"><label for="semester">Semester:</label></td>
                        <td class="p-4"><input type="number" id="semester" name="semester" min="1" max="14" required class="w-full p-2 border rounded border-black"></td>
                    </tr>
                    <tr>
    </table>
